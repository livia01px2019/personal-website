...
import paralegalImage from './images/paralegal.png'
...
import weenixImage from './images/weenix.png'
			...
			projects: [
				{
					title: "paralegal",
					src: paralegalImage,
					mainLink: "https://justus-adam.notion.site/Paralegal-User-Guide-6e483e6ad03d4701bea245caf1345fcf?pvs=74",
					links: [
						{
							name: "repo",
							link: "https://github.com/brownsys/paralegal"
						}, {
							name: "etos website",
							link: "https://etos.cs.brown.edu/"
						}],
					date: "jan 2022 - jan 2024",
					description: "Conducted research as part of the ETOS lab at Brown to create Paralegal, a privacy-preserving analysis tool for Rust."
				},
				{
					title: "weenix os",
					src: weenixImage,
					mainLink: "https://github.com/brown-cs1690/handout/wiki/Getting-Started-with-Weenix",
					links: [],
					date: "jan - may 2023",
					description: "Engineered a mini operating system as part of CS1690, including implementing the file system, virtual memory, driver, threads and processes."
				},
				{
					title: "tcp/ip",
					src: tcpImage,
